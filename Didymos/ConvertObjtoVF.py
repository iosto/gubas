import os
os.chdir('/home/fodde/Documents/Software/gubas/Didymos/')
...
sd = load_shape_from_obj('/home/fodde/Documents/Software/gubas/Apophis/ShapeFiles/apophis_brozovic_meters.obj')
...
filename = '/home/fodde/Documents/Software/gubas/Apophis/ShapeFiles/apophis_brozovic_meters_vert.csv'
with open(filename, 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerows(sd[0])

filename = '/home/fodde/Documents/Software/gubas/Apophis/ShapeFiles/apophis_brozovic_meters_facet.csv'
with open(filename, 'w', newline='') as f:
    writer = csv.writer(f)
    writer.writerows(sd[1])

# pc = art3d.Poly3DCollection(sd[0][sd[1] - 1, 1:], edgecolor="black", alpha=0.5)
...
vertex_didy = np.genfromtxt('home/fodde/Documents/Software/gubas/Apophis/ShapeFiles/apophis_brozovic_meters_vert.csv', usecols=[1,2,3], delimiter=',') 
facet_didy = np.genfromtxt('home/fodde/Documents/Software/gubas/Apophis/ShapeFiles/apophis_brozovic_meters_facet.csv', usecols=[0,1,2], delimiter=',', dtype=np.int16) 
pc = art3d.Poly3DCollection(vertex_didy[facet_didy - 1], edgecolor="black", alpha=0.5)
ax.add_collection(pc)
