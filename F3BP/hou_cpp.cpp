...
//inputs: x - row vector of input states specified in A frame with order [r,v,wc,ws,Cc,C,r3,v3], rotation matrices assumed to be row wrapped
//t - time seconds, this parameter is not used
//parameters inputs - structure defined at top of this code and commented in detail
//outputs: xd - RHS of equations of motion in same order as as but [rd,vd,wcd,wsd,Ccd,Cd,rd3,vd3] where d denotes rate of change
mat hou_ode(mat x, mat t, parameters inputs){
    //all inputs are in A frame
    //unpack states
    mat r=x.cols(0,2);
